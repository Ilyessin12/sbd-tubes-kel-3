...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::unprepared('DROP TRIGGER IF EXISTS `calculate_total_harga_before_booking_update`');

        // Create the new trigger
        DB::unprepared('
            CREATE TRIGGER `calculate_total_harga_before_booking_update` BEFORE UPDATE ON `booking`
            FOR EACH ROW BEGIN
                ...
                IF customer_status = \'member\' THEN
                    SET NEW.total_harga = 0; -- Or set to a member-specific calculation
                ELSE
